...
namespace libMultiRobotPlanning {
   template <typename State, typename Action, typename Cost, typename Conflict,
            typename Constraints, typename Environment, typename Location>
    class HieMAPF {
    public:
        HieMAPF(Environment& environment) : m_env(environment) {}
        ...
        void updateMap(const std::vector<Location> goals){ m_env.updateGoals(goals);}
